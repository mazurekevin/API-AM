...
"admin"        })    }, tags={ "PHASE 2", "Invoices" })
    ...
    @Operation(summary = "Add invoices", description = "Add a new invoices", security = {
        @SecurityRequirement(name = "ApiKey"),
@SecurityRequirement(name = "OAuth2", scopes = {
            "read",
"write",
"admin"        })    }, tags={ "Invoices" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "SUCCESS - Invoice created", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Invoice.class))),
    ...
    ResponseEntity<Invoice> postInvoice(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody Invoice body);
